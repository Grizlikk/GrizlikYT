namespace Prejmenovani_fotek
{
    partial class MainWindow
    {
		...
		private void InitializeComponent()
		{
			...
			UseModifiedDateCheckBox = new CheckBox();
			SuspendLayout();
			// 
			...
			ZobrazeniSouboruText.DetectUrls = false;
			...
			ZobrazeniSouboruText.KeyDown += ZobrazeniSouboruText_KeyDown;
			// 
			...
			TlacitkoPrejmenovat.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
			...
			FinalniPotvrzeni.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
			...
			MalePismenaPripona.MouseClick += MalePismenaPripona_MouseClick;
			// 
			// VelkePismenaPripona
			// 
			...
			VelkePismenaPripona.MouseClick += VelkePismenaPripona_MouseClick;
			// 
			// OriginalniPripona
			// 
			...
			OriginalniPripona.MouseClick += OriginalniPripona_MouseClick;
			// 
			// UseModifiedDateCheckBox
			// 
			UseModifiedDateCheckBox.Location = new Point(765, 275);
			UseModifiedDateCheckBox.Name = "UseModifiedDateCheckBox";
			UseModifiedDateCheckBox.Size = new Size(107, 50);
			UseModifiedDateCheckBox.TabIndex = 12;
			UseModifiedDateCheckBox.Text = "Vždy použít datum úpravy souboru";
			UseModifiedDateCheckBox.TextAlign = ContentAlignment.MiddleCenter;
			UseModifiedDateCheckBox.UseVisualStyleBackColor = true;
			UseModifiedDateCheckBox.CheckedChanged += UseModifiedDateCheckBox_CheckedChanged;
			// 
			// MainWindow
			// 
			...
			Controls.Add(UseModifiedDateCheckBox);
		...
		private CheckBox UseModifiedDateCheckBox;
	}
}